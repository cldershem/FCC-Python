...
The sytntax for Python has very few keywords and symbols, making it read a lot
like English or 'psuedo code'. One unique characterstic of Python is its use of
whitespace instead of curly braces to seperate blocks.
...
Python, 2.7 and 3.6. This tutorial will be teaching Python while occassionally
...
# Getting Started
"""
Python is an interpretted language, more like JavaScript than C, if you're on
Mac or Linux you've already got a Python interpretter installed, if you're on
